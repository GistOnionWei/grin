...
pub const WALLET_CONFIG_FILE_NAME: &'static str = "libercoin-wallet.toml";
const SERVER_LOG_FILE_NAME: &'static str = "libercoin-server.log";
const WALLET_LOG_FILE_NAME: &'static str = "libercoin-wallet.log";
const LIBERCOIN_HOME: &'static str = ".libercoin";
const LIBERCOIN_CHAIN_DIR: &'static str = "chain_data";
/// Wallet data directory
pub const LIBERCOIN_WALLET_DIR: &'static str = "wallet_data";
...
impl GlobalWalletConfig {
	...
	pub fn update_paths(&mut self, wallet_home: &PathBuf) {
		...
		wallet_path.push(LIBERCOIN_WALLET_DIR);
