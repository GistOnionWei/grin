...
//! patterns that are frequent within the libercoin codebase.
...
/// Global stopped/paused state shared across various subcomponents of Libercoin.
///
...
///
/// "Stopped" allows a clean shutdown of the Libercoin server.
