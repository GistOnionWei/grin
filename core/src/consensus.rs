...
/// A libercoin is divisible to 10^9, following the SI prefixes
pub const LIBERCOIN_BASE: u64 = 1_000_000_000;
/// Millilibercoin, a thousand of a libercoin
pub const MILLI_LIBERCOIN: u64 = LIBERCOIN_BASE / 1_000;
/// Microlibercoin, a thousand of a millilibercoin
pub const MICRO_LIBERCOIN: u64 = MILLI_LIBERCOIN / 1_000;
/// Nanolibercoin, smallest unit, takes a billion to make a libercoin
pub const NANO_LIBERCOIN: u64 = 1;
