...
The full state of a Libercoin chain consists of all the following data:
...
With a full Libercoin state, we can validate the following:
...
Data storage for outputs, range proofs and kernels in Libercoin is simple: a plain
