...
A Libercoin transaction consists of the following -
...
Libercoin does not permit duplicate commitments to exist in the Output set at the same time.
...
This is not necessarily recommended but Libercoin must handle this situation in a way that does not break consensus across the network.
...
Libercoin does not allow duplicate commitments to exist in the Output set simultaneously.
