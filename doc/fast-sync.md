...
In Libercoin, we call "sync" the process of synchronizing a new node or a node that
...
by other blockchains, but this is problematic for Libercoin as it typically does not
download full blocks.

In short, a fast-sync in Libercoin does the following:
