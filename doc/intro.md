# Introduction to MimbleWimble and Libercoin
...
Libercoin is an open source software project that implements a MimbleWimble
blockchain and fills the gaps required for a full blockchain and
cryptocurrency deployment.

The main goal and characteristics of the Libercoin project are:
...
to explain the technical buildup of MimbleWimble and how it's applied in Libercoin. We hope
this document is understandable to most technically-minded readers. Our objective is
to encourage you to get interested in Libercoin and contribute in any way possible.

To achieve this objective, we will introduce the main concepts required for a good
understanding of Libercoin as a MimbleWimble implementation. We will start with a brief
description of some relevant properties of Elliptic Curve Cryptography (ECC) to lay the
foundation on which Libercoin is based and then describe all the key elements of a
...
Deterministic wallets heavily rely on this principle. MimbleWimble and the Libercoin
...
Libercoin, so if you're in a hurry, feel free to jump straight to
